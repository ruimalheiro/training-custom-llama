...
if __name__ == '__main__':
    ...
    parser.add_argument('--instruct', action='store_true', help='Prepare instruct (SFT) dataset')
    parser.add_argument('--dpo', action='store_true', help='Prepare DPO (Direct Preference Optimization) dataset')
    ...
    if args.pretraining:
        ...
        prepare_dpo_dataset(datasets_mix=load_custom_dataset_mix(args.mix_file))
